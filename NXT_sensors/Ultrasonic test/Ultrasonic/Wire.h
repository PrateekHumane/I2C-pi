...
public:
	...
	uint8_t writes(uint8_t data);//write one byte of data to slave currently in transmission with
	uint8_t writes(uint8_t *data, uint8_t numBytes);//write x bytes of data to slave currently in transmission
